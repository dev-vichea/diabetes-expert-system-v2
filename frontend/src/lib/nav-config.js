...
export const NAV_ITEMS = [
  ...
  { to: '/care-plan', labelKey: 'nav.carePlan', icon: HeartPulse, section: 'workspace', permissions: ['care_plan.view_own', 'treatment_plan.view', 'patient.view'], permissionMode: 'any' },
