  ...
  "en": {
    ...
    "assessment": {
      ...
      "interview": {
        ...
        "insightCheckTitle": "Sign noted — the assessment keeps going",
        "insightCheckText": "Stomach pain, vomiting, fruity breath or deep breathing can have many causes, and one sign on its own is not an emergency. The next questions help me tell whether this fits a pattern that needs urgent care.",
    ...
    "diagnosisResult": {
      ...
      "preventionIntro": "Healthy lifestyle choices can help prevent type 2 diabetes. If you have prediabetes, lifestyle changes may slow the condition or keep it from becoming diabetes.",
      "preventionListIntro": "A healthy lifestyle includes the following:",
      "preventionEatLead": "Eat healthy foods.",
      "preventionEatText": "Choose foods lower in fat and calories and higher in fiber. Focus on fruits, vegetables and whole grains.",
      "preventionActiveLead": "Be active.",
      "preventionActiveText": "Aim for 150 or more minutes a week of moderate to vigorous aerobic activity, such as brisk walking, bicycling, running or swimming.",
      "preventionWeightLead": "Lose weight.",
      "preventionWeightText": "If you are overweight, losing some weight and keeping it off may slow prediabetes from becoming type 2 diabetes. If you have prediabetes, losing 7% to 10% of your body weight may lower the risk of diabetes.",
      "preventionSitLead": "Don't sit for long.",
      "preventionSitText": "Sitting for long periods can raise the risk of type 2 diabetes. Get up every 30 minutes and move around for at least a few minutes.",
      "preventionMetformin": "People with prediabetes may take metformin (Fortamet, Glumetza, others), a diabetes medicine, to lower the risk of type 2 diabetes. This is most often prescribed for older adults who are obese and who can't lower blood sugar levels with lifestyle changes.",
      "preventionGdmTitle": "Gestational diabetes — care & prevention",
      "preventionGdmIntro": "During pregnancy your blood-sugar targets are stricter. Gestational diabetes can usually be managed well — and its risks greatly reduced — with early care.",
      "preventionGdmWatchLead": "Watch your blood sugar.",
      "preventionGdmWatchText": "Test as your obstetric team advises. The 75g OGTT around weeks 24–28 confirms or rules out gestational diabetes — earlier if you have risk factors.",
      "preventionGdmEatLead": "Eat for steady glucose.",
      "preventionGdmEatText": "Smaller, regular meals built on whole grains, vegetables and protein help avoid sugar spikes. Ask for a dietitian referral.",
      "preventionGdmActiveLead": "Stay active.",
      "preventionGdmActiveText": "A short walk after meals lowers glucose spikes. Keep to the activity level your doctor approves for your pregnancy.",
      "preventionGdmFollowUpLead": "Follow up after birth.",
      "preventionGdmFollowUpText": "Gestational diabetes raises your lifetime type 2 risk. Re-test 4–12 weeks after delivery, then every 1–3 years.",
      "preventionGdmNote": "Any diabetes treatment during pregnancy needs obstetric supervision — never start or stop medication on your own.",
      "preventionDiabetesTitle": "Diabetes — protect yourself starting today",
      "preventionDiabetesIntro": "Your results meet diabetes-level evidence. These steps protect your eyes, kidneys, nerves and heart — the earlier you start, the better.",
      "preventionDiabetesDoctorLead": "See a doctor promptly.",
      "preventionDiabetesDoctorText": "Bring these results with you. Diabetes treatment works best when it starts early — your doctor will set targets and a monitoring plan with you.",
      "preventionDiabetesLabsLead": "Confirm with lab tests.",
      "preventionDiabetesLabsText": "If you have not had one yet, a fasting glucose or HbA1c test confirms the result and becomes your baseline for tracking.",
      "preventionDiabetesBasicsLead": "Start the basics now.",
      "preventionDiabetesBasicsText": "The same lifestyle that prevents diabetes also treats it: healthy food, 150 minutes of activity a week, and a steady weight.",
      "preventionDiabetesCheckLead": "Check for complications.",
      "preventionDiabetesCheckText": "Ask your doctor about eye, kidney, foot and blood-pressure checks — catching problems early prevents lasting damage.",
      "preventionDiabetesNote": "Urgent warning signs — vomiting, fruity breath, deep rapid breathing, or confusion — need emergency care straight away.",
      "preventionRiskTitle": "Lower your risk now",
      "preventionRiskIntro": "No diabetes yet — but your risk factors make prevention worthwhile. Small, steady changes cut the risk sharply.",
      "preventionRiskMoveLead": "Move 150 minutes a week.",
      "preventionRiskMoveText": "Brisk walking, cycling or swimming — anything that raises your breathing — is the single most effective habit.",
      "preventionRiskWeightLead": "Keep a healthy weight.",
      "preventionRiskWeightText": "If you are overweight, losing 5–10% of your body weight measurably improves blood sugar and blood pressure.",
      "preventionRiskFoodLead": "Eat more whole foods.",
      "preventionRiskFoodText": "Build meals around vegetables, whole grains and lean protein; go easy on sugary drinks and processed snacks.",
      "preventionRiskScreenLead": "Re-screen on schedule.",
      "preventionRiskScreenText": "With risk factors, screen for diabetes every 1–3 years — sooner if prediabetes is ever found.",
      "urgentTag": "Urgent",
      "priority": "Priority",
      "rule": "Rule:",
  ...
  "km": {
    ...
    "assessment": {
      ...
      "interview": {
        ...
        "insightCheckTitle": "សញ្ញាត្រូវបានកត់ត្រា — ការវាយតម្លៃបន្តទៅ",
        "insightCheckText": "ឈឺក្បុន ក្អួត ដង្ហើមមានក្លិនផ្លែឈើ ឬដកដង្ហើមជ្រៅលឿន អាចមានមូលហេតុច្រើន ហើយសញ្ញាតែមួយមិនមែនជាអាសន្នទេ។ សំណួរបន្ទាប់នឹងជួយប្រាប់ថាតើសញ្ញាទាំងនេះផ្គូផ្គងនឹងលំនាំដែលត្រូវការថែទាំបន្ទាន់ដែរឬទេ។",
    ...
    "diagnosisResult": {
      ...
      "preventionTitle": "ការការពារ",
      "preventionIntro": "ជម្រើសរបៀបរស់នៅដែលមានសុខភាពល្អ អាចជួយការពារជំងឺទឹកនោមផ្អែមប្រភេទទី ២។ ប្រសិនបើអ្នកមានមុនទឹកនោមផ្អែម ការផ្លាស់ប្តូររបៀបរស់នៅអាចធ្វើឲ្យស្ថានភាពរីកចម្រើនយឺតយូរ ឬការពារមិនឲ្យវិវត្តទៅជាជំងឺទឹកនោមផ្អែម។",
      "preventionListIntro": "របៀបរស់នៅដែលមានសុខភាពល្អ រួមបញ្ចូលដូចតទៅ៖",
      "preventionEatLead": "ញ៉ាំអាហារដែលមានសុខភាពល្អ។",
      "preventionEatText": "ជ្រើសរើសអាហារដែលមានខ្លាញ់ និងកាឡូរីទាប តែមានជាតិសាច់អំបៅខ្ពស់។ ផ្តោតលើផ្លែឈើ បន្លែ និងគ្រាប់ធញ្ញជាតិទាំងមូល។",
      "preventionActiveLead": "ធ្វើចលនាឲ្យបានទៀងទាត់។",
      "preventionActiveText": "កំណត់គោលដៅ ១៥០ នាទី ឬច្រើនជាងនេះក្នុងមួយសប្តាហ៍ នៃសកម្មភាពកាយសម្ពន្ធកម្មកម្រិតមធ្យមដល់ខ្លាំង ដូចជា ដើរលឿន ជិះកង់ រត់ ឬហែលទឹក។",
      "preventionWeightLead": "បន្ថយទម្ងន់។",
      "preventionWeightText": "ប្រសិនបើអ្នកលើសទម្ងន់ ការបន្ថយទម្ងន់បន្តិច និងរក្សាវាឲ្យបានរហូត អាចធ្វើឲ្យមុនទឹកនោមផ្អែមយឺតយូរក្លាយជាទឹកនោមផ្អែមប្រភេទទី ២។ ប្រសិនបើអ្នកមានមុនទឹកនោមផ្អែម ការបន្ថយទម្ងន់ ៧% ទៅ ១០% អាចកាត់បន្ថយហានិភ័យនៃជំងឺទឹកនោមផ្អែម។",
      "preventionSitLead": "កុំអង្គុយយូរពេក។",
      "preventionSitText": "ការអង្គុយយូរៗ អាចបង្កើនហានិភ័យនៃជំងឺទឹកនោមផ្អែមប្រភេទទី ២។ ក្រោកឡើងរាល់ ៣០ នាទី ហើយចេញចលនាយ៉ាងតិចរយៈពេលប៉ុន្មាននាទី។",
      "preventionMetformin": "អ្នកដែលមានមុនទឹកនោមផ្អែម អាចប្រើថ្នាំ Metformin (Fortamet, Glumetza ជាដើម) ដែលជាថ្នាំទឹកនោមផ្អែម ដើម្បីកាត់បន្ថយហានិភ័យនៃជំងឺទឹកនោមផ្អែមប្រភេទទី ២។ ភាគច្រើនថ្នាំនេះត្រូវបានចេញវេជ្ជបញ្ជាសម្រាប់មនុស្សមានអាយុច្រើនដែលធាត់ ហើយមិនអាចកាត់បន្ថយស្ករឈាមដោយការផ្លាស់ប្តូររបៀបរស់នៅបានទេ។",
      "preventionGdmTitle": "ទឹកនោមផ្អែមពេលមានផ្ទៃពោះ — ការថែទាំ និងការការពារ",
      "preventionGdmIntro": "ពេលមានផ្ទៃពោះ កម្រិតជាតិស្ករត្រូវបានធ្វើឱ្យច្បាស់ជាង។ ទឹកនោមផ្អែមពេលមានផ្ទៃពោះ ភាគច្រើនអាចគ្រប់គ្រងបានល្អ ហើយកាត់បន្ថយហានិភ័យបានច្រើន ប្រសិនបើមានការថែទាំតាំងពីដំបូង។",
      "preventionGdmWatchLead": "តាមដានជាតិស្កររបស់អ្នក។",
      "preventionGdmWatchText": "ពិនិត្យតាមការណែនាំរបស់ក្រុមគ្រូពេទ្យពេលមានផ្ទៃពោះ។ តេស្ត OGTT 75g នៅសប្តាហ៍ 24–28 អាចបញ្ជាក់ឬបដិសេធទឹកនោមផ្អែមពេលមានផ្ទៃពោះ — ធ្វើមុនពេលប្រសិនបើអ្នកមានកត្តាហានិភ័យ។",
      "preventionGdmEatLead": "ញ៉ាំដើម្បីឱ្យជាតិស្ករមានស្ថិរភាព។",
      "preventionGdmEatText": "អាហារតិចៗ ញ៉ាំទៀងទាត់ ដោយផ្អែកលើគ្រាប់ធញ្ញជាតិទាំងមូល បន្លែ និងប្រូតេអ៊ីន ជួយការពារជាតិស្ករឡើងខ្ពស់។ សូមសុំការណែនាំទៅអ្នកជំនាញអាហារូបត្ថម្ភ។",
      "preventionGdmActiveLead": "ធ្វើចលនាឲ្យបានទៀងទាត់។",
      "preventionGdmActiveText": "ដើរខ្លីៗបន្ទាប់ពីអាហារ ជួយកាត់បន្ថយជាតិស្ករឡើងខ្ពស់។ រក្សាកម្រិតសកម្មភាពដែលគ្រូពេទ្យអនុញ្ញាត សម្រាប់ការមានផ្ទៃពោះរបស់អ្នក។",
      "preventionGdmFollowUpLead": "ពិនិត្យបន្តបន្ទាប់ពីសម្រាល។",
      "preventionGdmFollowUpText": "ទឹកនោមផ្អែមពេលមានផ្ទៃពោះ បង្កើនហានិភ័យនៃជំងឺទឹកនោមផ្អែមប្រភេទទី ២ អស់មួយជីវិត។ ពិនិត្យឡើងវិញ ៤–១២ សប្តាហ៍បន្ទាប់ពីសម្រាល រួចរាល់ ១–៣ ឆ្នាំ។",
      "preventionGdmNote": "ការព្យាបាលទឹកនោមផ្អែមពេលមានផ្ទៃពោះ ត្រូវការការត្រួតពិនិត្យពីគ្រូពេទ្យ — កុំចាប់ផ្តើមឬឈប់ថ្នាំដោយខ្លួនឯង។",
      "preventionDiabetesTitle": "ជំងឺទឹកនោមផ្អែម — ការពារខ្លួនចាប់ពីថ្ងៃនេះ",
      "preventionDiabetesIntro": "លទ្ធផលរបស់អ្នកប្រកបដោយភស្តុតាងកម្រិតទឹកនោមផ្អែម។ ជំហានទាំងនេះជួយការពារភ្នែក តំរងនោម សរសៃប្រសាទ និងបេះដូងរបស់អ្នក — ចាប់ផ្តើមកុំពន្យារពេល។",
      "preventionDiabetesDoctorLead": "ជួបគ្រូពេទ្យឱ្យបានឆាប់។",
      "preventionDiabetesDoctorText": "យកលទ្ធផលទាំងនេះទៅជាមួយ។ ការព្យាបាលទឹកនោមផ្អែមមានប្រសិទ្ធភាពបំផុតពេលចាប់ផ្តើមតែម្តង — គ្រូពេទ្យនឹងកំណត់គោលដៅ និងផែនការតាមដានជាមួយអ្នក។",
      "preventionDiabetesLabsLead": "បញ្ជាក់ដោយតេស្តមន្ទីរពិសោធន៍។",
      "preventionDiabetesLabsText": "ប្រសិនបើអ្នកមិនទាន់បានធ្វើ តេស្តជាតិស្ករអត់ភោជន៍ ឬ HbA1c អាចបញ្ជាក់លទ្ធផល ហើយក្លាយជាគោលដៅសម្រាប់តាមដាន។",
      "preventionDiabetesBasicsLead": "ចាប់ផ្តើមមូលដ្ឋានឥឡូវនេះ។",
      "preventionDiabetesBasicsText": "របៀបរស់នៅដែលការពារទឹកនោមផ្អែម ក៏ជួយព្យាបាលវាដែរ៖ អាហារមានសុខភាពល្អ សកម្មភាព ១៥០ នាទីក្នុងមួយសប្តាហ៍ និងទម្ងន់ស្ថិរភាព។",
      "preventionDiabetesCheckLead": "ពិនិត្យរកផលប៉ះពាល់។",
      "preventionDiabetesCheckText": "សួរគ្រូពេទ្យអំពីការពិនិត្យភ្នែក តំរងនោម ជើង និងសម្ពាធឈាម — ការរកឃើញតាំងពីដំបូងជួយការពារការខូចខាតអចិន្ត្រៃយ៍។",
      "preventionDiabetesNote": "សញ្ញាបន្ទាន់ — ក្អួត ដង្ហើមមានក្លិនផ្លែប៉ោម ដង្ហើមធំនិងលឿន ឬស្មារតីមិនច្បាស់ — ត្រូវទៅសង្គ្រោះបន្ទាន់ភ្លាមៗ។",
      "preventionRiskTitle": "កាត់បន្ថយហានិភ័យរបស់អ្នកឥឡូវនេះ",
      "preventionRiskIntro": "មិនទាន់មានទឹកនោមផ្អែមទេ — ប៉ុន្តែកត្តាហានិភ័យរបស់អ្នកធ្វើឱ្យការការពារមានសារៈសំខាន់។ ការផ្លាស់ប្តូរតូចៗទៀងទាត់ កាត់បន្ថយហានិភ័យយ៉ាងខ្លាំង។",
      "preventionRiskMoveLead": "ធ្វើចលនា ១៥០ នាទីក្នុងមួយសប្តាហ៍។",
      "preventionRiskMoveText": "ដើរលឿន ជិះកង់ ឬហែលទឹក — អ្វីៗដែលធ្វើឱ្យដង្ហើមលឿន — គឺជាទម្លាប់មានប្រសិទ្ធភាពបំផុត។",
      "preventionRiskWeightLead": "រក្សាទម្ងន់មានសុខភាពល្អ។",
      "preventionRiskWeightText": "ប្រសិនបើអ្នកលើសទម្ងន់ ការបន្ថយទម្ងន់ ៥–១០% ធ្វើឱ្យជាតិស្ករឈាម និងសម្ពាធឈាមប្រសើរឡើងច្បាស់។",
      "preventionRiskFoodLead": "ញ៉ាំអាហារធម្មជាតិច្រើនជាង។",
      "preventionRiskFoodText": "ភ្ជាប់អាហារលើបន្លែ គ្រាប់ធញ្ញជាតិទាំងមូល និងប្រូតេអ៊ីនស្រាលៗ ហើយកាត់បន្ថយភេសជ្ជៈផ្អែម និងអាហារកែច្នៃ។",
      "preventionRiskScreenLead": "ពិនិត្យជាប្រចាំតាមកំណត់។",
      "preventionRiskScreenText": "ប្រសិនបើមានកត្តាហានិភ័យ ពិនិត្យទឹកនោមផ្អែមរាល់ ១–៣ ឆ្នាំ — កាន់ត់ឆាប់ប្រសិនបើរកឃើញមុនទឹកនោមផ្អែម។",
      "urgentTag": "បន្ទាន់",
      "priority": "អាទិភាព",
      "rule": "វិធាន៖",
...
export const exactTextMap = {
  ...
  // v2 rule seed recommendation strings
  'Your test results meet the diabetes threshold. See a doctor soon to start treatment and a monitoring plan — bring these results with you.': 'លទ្ធផលតេស្តរបស់អ្នកបំពេញកម្រិតនៃជំងឺទឹកនោមផ្អែម។ សូមជួបគ្រូពេទ្យឱ្យបានឆាប់ ដើម្បីចាប់ផ្តើមការព្យាបាល និងផែនការតាមដាន — យកលទ្ធផលទាំងនេះទៅជាមួយ។',
  'You reported feeling in crisis. Seek emergency medical care now — do not wait for test results or appointments.': 'អ្នកបានប្រាប់ថាអ្នកមានអារម្មណ៍ធ្ងន់ធ្ងរខ្លាំង។ សូមទៅសង្គ្រោះបន្ទាន់ឥឡូវនេះ — កុំរង់ចាំលទ្ធផលតេស្ត ឬការណាត់ជួប។',
