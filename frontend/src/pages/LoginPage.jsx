      ...
      <section className={`auth-card ${cardAnimationClass}`}>
        <aside className="auth-panel auth-panel-accent auth-panel-accent--left">
          <div className="auth-accent-content">
            <span className="auth-eyebrow">Diabetes Expert System</span>
            <h1 className="auth-accent-title">Hello, Welcome!</h1>
            <p className="auth-accent-copy">
              Don&apos;t have an account yet? Create one to access diagnosis tools, patient history, and smarter follow-up care.
            </p>
            <Link to="/sign-up" state={{ authTransition: 'to-register' }} className="auth-outline-button">Register</Link>
          </div>
        </aside>
        ...
        <section className="auth-panel auth-panel-form">
          <div className="auth-form-inner">
            <div className="auth-form-header">
              ...
              <p className="auth-form-copy">Sign in to continue to your dashboard.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <p className="auth-bottom-link">
                Don&apos;t have an account? <Link to="/sign-up" state={{ authTransition: 'to-register' }}>Sign up</Link>
              </p>
            </form>
          </div>
        </section>
